Shader "Image/Terrain/Terrain Diffuse IBL" {
...
CGPROGRAM
	...
	#pragma glsl
#endif
//NOTE: BlinnPhong instead of ImageDirect is fine here, ImageDirect is only needed for RGB specular
#pragma surface ImageTerrainSurf BlinnPhong vertex:ImageTerrainVert fullforwardshadows addshadow
#pragma target 3.0
...
#include "ImageTerrain.cginc"

ENDCG  
}

Dependency "AddPassShader" = "Hidden/Image/Terrain/Terrain IBL AddPass"
Dependency "BaseMapShader" = "Hidden/Image/Terrain/Distant IBL"
