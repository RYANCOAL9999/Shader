#ifndef Image_TERRAIN_CGINC
#define Image_TERRAIN_CGINC
...
void ImageTerrainVert (inout appdata_full v, out Input o) {
...
void ImageTerrainSurf (Input IN, inout SurfaceOutput OUT) {
