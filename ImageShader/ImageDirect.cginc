#ifndef Image_DIRECT_CGINC
#define Image_DIRECT_CGINC

//deferred lighting
inline half4 LightingImageDirect_PrePass( ImageOutput s, half4 light ) {
...
//forward lighting
inline half4 LightingImageDirect( ImageOutput s, half3 lightDir, half3 viewDir, half atten ) {
...
inline half4 LightingImageDirect_DirLightmap (ImageOutput s, fixed4 color, fixed4 scale, half3 viewDir, bool surfFuncWritesNormal, out half3 specColor) {
	UNITY_DIRBASIS
